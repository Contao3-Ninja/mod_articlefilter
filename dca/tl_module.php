<?php
  ...
  $GLOBALS['TL_DCA']['tl_module']['palettes']['articlefilter_links'] = '{title_legend},name,headline,type;{config_legend},af_groups,af_defaultfilter;{redirect_legend},jumpTo;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
