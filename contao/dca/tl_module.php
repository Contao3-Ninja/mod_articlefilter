...
$GLOBALS['TL_DCA']['tl_module']['palettes']['articlefilter_results'] = '{title_legend},name,headline,type;{config_legend},articlefilter_showfilter,articlefilter_sorting,perPage,imgSize;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
